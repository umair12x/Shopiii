...
3. Use auth-based rules for production:
    ```json
    {
       "rules": {
          ".read": "auth != null",
    ...
    ```
4. For temporary testing only, use open rules and switch back after validation
...
- [Project documentation index](doc/README.md)
- [Architecture](doc/ARCHITECTURE.md)
- [Setup guide](doc/SETUP.md)
- [Firebase sync guide](doc/FIREBASE.md)
